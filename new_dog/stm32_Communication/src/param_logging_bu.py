...
dic = {'total_weight':15,
       ...
       "swingleg_P":[200,180,180],  # 100,100,150
       "swingleg_D":[80,18,35],  # 18
       #  "swingleg_P":[0,0,0],  # 100,100,150
       # "swingleg_D":[0,0,0],  # 18
        "groundleg_P4":[0,0,120],  #[80,50,120]
       "groundleg_D4":[15,10,10],
       "groundleg_P2": [0, 0, 250],  # [0, 0, 150]
       "groundleg_D2": [15, 10, 40],
...
if dic["state_estimation_mode"] == 0:
    ...
    dic["trot_force_p"] = [450,450,400]
    dic["trot_force_D"] = [550,350,30]
